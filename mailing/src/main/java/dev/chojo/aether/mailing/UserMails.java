...
public interface UserMails {
    /**
     * Retrieve a {@link MailEntry} for the given hash
     *
    ...
    /**
     * Add a new {@link MailEntry} to the users mails
     *
    ...
    /**
     * Remove a {@link MailEntry} from the users mails that matches the given hash
     *
     * @param mailHash The hash of the {@link MailEntry} to remove
